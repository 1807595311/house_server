module.exports = (d)=>{
    return {
        follows: `SELECT 
                    ...
                    f.create_time
                    FROM follows AS f
                    INNER JOIN users AS u ON f.account_number = u.account_number
        ...
        collection: `SELECT
                    ...
                    INNER JOIN users AS u ON u.account_number = c.account_number
        ...
        fabulous: `SELECT
                    ...
                    INNER JOIN users AS u ON u.account_number = f.account_number
                    WHERE d.account_number='${d.account_number}';`,
        commentReply: `SELECT 
                    c.id,
                    c.dynamic_id,
